class Utils:
    ...
    ASSETS = {
        "background_layer_1": "assets/graphics/scene/background_layer_1.png",
        "background_layer_2": "assets/graphics/scene/background_layer_2.png",
        "background_layer_3": "assets/graphics/scene/background_layer_3.png",

        "dirt_ground": "assets/graphics/scene/dirt_ground.png",

        "snail": "assets/graphics/interactive/snail.png",
        
        "player_stand": "assets/graphics/interactive/player_stand.png"
    }
